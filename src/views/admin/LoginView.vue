...
const login = async () => {
    ...
    try {
        ...
        eventStore.popupMessage('success', error.message)
    }
}
</script>
            ...
            <div class="py-24 px-10">
                ...
                <div class="mb-4">
                    <div class="form-control w-full mt-4">
                        ...
                        <input v-model="email" type="emailId" placeholder="" class="input input-bordered w-full" value="" />
                    </div>
                    <div class="form-control w-full mt-4">
                        <label class="label"><span class="label-text text-base-content undefined">Password</span></label>
                        <input v-model="password" type="password" placeholder="" class="input input-bordered w-full" value="" />
                    </div>
                </div>
