                ...
                <div class="mt-6 sm:mt-10 md:gap-6 lg:flex lg:items-start xl:gap-8">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <button type="button" @click="toggleFavorite"
                                                ...
                                                <svg :class="['me-1.5 h-5 w-5', isFavorite ? 'heart-pulse' : '']"
                                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" fill="none" viewBox="0 0 24 24">
                                                    <path :stroke="isFavorite ? 'rgb(239, 68, 68)' : 'currentColor'"
                        ...
                        <div class="hidden xl:mt-8 xl:block">
                            ...
                            <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
                                <div v-for="item in [1, 2, 3]" :key="item"
                                    ...
                                    <div>
                                        <a href="#"
                                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline ">iMac
                                            27”</a>
                    ...
                    <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                        <div
                            ...
                            <RouterLink :to="{ name: 'checkout' }" href="#"
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <RouterLink :to="{ name: 'home' }" href="#" title=""
